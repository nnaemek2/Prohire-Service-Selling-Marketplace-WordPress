	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Home 1', 'prohire' ),
				'page'  => __( 'Home 1', 'prohire' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shthemes.net/demosd/prohire/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Prohire Home 2', 'prohire' ),
				'page'  => __( 'Home 2', 'prohire' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shthemes.net/demosd/prohire/?page_id=116',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import Prohire Home 3', 'prohire' ),
				'page'  => __( 'Home 3', 'prohire' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shthemes.net/demosd/prohire/?page_id=166',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'prohire' ),
			);
		}
