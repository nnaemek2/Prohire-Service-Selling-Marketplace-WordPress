 ...
 * @since 1.0.0
 */
class BdevsSignup extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Sign Up & Login Form', 'bdevs-elementor' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Bdevs Sign Up Form widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Retrieve the list of categories the Bdevs Sign Up Form widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'dynamic' => [ 'active' => true ],
				'default'		=> __('Form', 'bdevs-elementor'),
