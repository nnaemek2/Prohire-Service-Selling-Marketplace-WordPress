        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="breadcrumbs-title">
                    <h1>
                        <?php if(isset($prohire_redux_demo['blog_title']) && $prohire_redux_demo['blog_title'] != ''){?>
                        <?php echo wp_specialchars_decode(esc_attr($prohire_redux_demo['blog_title']));?>
                        <?php }else{?>
                        <?php echo esc_html__( 'Blog', 'prohire' );
                        }
                        ?>
                    </h1>
...
<div class="blog-area-v1 pt-120 pb-80">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
            <?php } ?>
                <div class="blog-post-wrapper blog-grid">
                    <div class="row">
                        <?php
                            $args = array(    
                                          'paged' => $paged,
                        ...
                        <div class="col-md-6">
                            <div class="blog-post-item mb-40">
                                ...
                                <?php }else{?>
                                <div class="post-thumbnail">
                                    <a href="<?php the_permalink(); ?>"><img src="https://shthemes.net/demosd/prohire/wp-content/uploads/2024/03/blog-2.jpg" alt="<?php the_title_attribute(); ?>"></a>
                                    <a href="<?php the_permalink(); ?>" class="date"><?php the_time(get_option('date_format')); ?></a>
                                </div>
                                <?php } ?>
