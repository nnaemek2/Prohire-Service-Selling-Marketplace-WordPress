...
final class BdevsElementor {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Prohire Elementor', 'bdevs-elementor' ) . '</strong>',
	...
	public function add_elementor_category() {
    	\Elementor\Plugin::instance()->elements_manager->add_category('bdevs-elementor',
	      	array(
					'title' => __( 'Prohire Elementor', 'bdevs-elementor' ),
					'icon'  => 'fa fa-plug',
	      	) 
	    );
	}
	...
	*/
	...
	public function init_widgets() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/start-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/brand-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/form-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/signup-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/testimonial-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/categories-widget.php';


		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsStart() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCategories() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsNewsletter() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsFeatures() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsForm() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsSignup() );	
