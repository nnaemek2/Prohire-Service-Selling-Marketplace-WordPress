...
class BdevsContactInfo extends \Elementor\Widget_Base {
	...
	public function render() {
		...
		extract($settings);
		?>
		<!--====== Start contact informaiton section ======-->
        <div class="contact-informatoin pt-120">
            <div class="container">
                <div class="row information-wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="information-item mb-50">
                            ...
                            <div class="info">
                                <?php print wp_kses_post($item['contact_info']); ?>
                            </div>
                        </div>
                    </div>
                	<?php endforeach; ?>
        ...
        <!--====== End contact informaiton section ======-->
	<?php
	}
